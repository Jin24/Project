...
values = (0,0,b'testing to send message')
...
values = (0,0,b'testing to send message',chksum)
UDP_Packet_Data = struct.Struct('I I 32s 32s')
...
while check:
    ...
    try:
        ...
        #sock.sendto(messageB, (UDP_IP,UDP_PORT))
        #sock.recvfrom(1024)
